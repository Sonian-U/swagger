    ...
    public sealed class SwaggerPetstoreOpenAPI30Client : IConfiguration
    {
            ...
            IHttpClientConfiguration httpClientConfiguration)
        {
            ...
            this.pet = new Lazy<PetController>(
                () => new PetController(this, this.httpClient, this.authManagers, this.httpCallBack));
            this.store = new Lazy<StoreController>(
                () => new StoreController(this, this.httpClient, this.authManagers, this.httpCallBack));
            ...
            if (!this.authManagers.ContainsKey("global")
                || !this.CustomHeaderAuthenticationCredentials.Equals(apiKey))
            {
                this.customHeaderAuthenticationManager = new CustomHeaderAuthenticationManager(apiKey);
        ...
        public Builder ToBuilder()
        {
            Builder builder = new Builder()
                ...
                .CustomHeaderAuthenticationCredentials(this.customHeaderAuthenticationManager.ApiKey)
